...
import fs from 'fs';
import { RESOURCES, ARCHETYPES, MAX_ENERGY, ENERGY_REGEN, BASE_BUILD_CAP, TILE_MINT_COSTS, RARITY_TABLE, RANDOM_QUEST_TEMPLATES } from './constants.js';
...
export class World {
  ...
  _cmdScavenge(agent) {
    ...
    // Roll for loot items
    const items = rollLoot(tile, this.tick);
